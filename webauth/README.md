...
> address credentials. Protocol 27 address-v2 credentials and delegates are
> rejected explicitly until the SEP defines their use.
...
console.log(token.protocol); // "sep10"
...
ContractAuth.fromSigner(colibriSigner);
