...
describe("SEP-45 passkey fixtures", () => {
  it("normalizeP256Signature accepts raw and canonical DER forms", () => {
  ...
  it("test passkey credential builds a verifiable WebAuthn-shaped assertion", async () => {
  ...
  it("test passkey assertion binds entry, expiration, and network", async () => {
    const fixture = createWebAuthFixture();
    const credential = await createTestPasskeyCredential();
    const entry = sep45Entry(fixture, fixture.contractAccount);
    const base = {
