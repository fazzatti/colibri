...
export const CONTRACT_EVENT_ERRORS = {
  [Code.INVALID_SPEC]: INVALID_SPEC,
  [Code.UNKNOWN_EVENT]: UNKNOWN_EVENT,
  [Code.DECODE_FAILED]: DECODE_FAILED,
  [Code.INVALID_FILTER]: INVALID_FILTER,
  [Code.AMBIGUOUS_EVENT]: AMBIGUOUS_EVENT,
};
