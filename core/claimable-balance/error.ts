...
export const ERROR_CBPR = {
  ["CBPR_001" as Code.INVALID_DATE]: INVALID_DATE,
  ["CBPR_002" as Code.INVALID_ABSOLUTE_TIME]: INVALID_ABSOLUTE_TIME,
  ["CBPR_003" as Code.INVALID_RELATIVE_TIME]: INVALID_RELATIVE_TIME,
  ["CBPR_004" as Code.INVALID_PREDICATE]: INVALID_PREDICATE,
  ["CBPR_005" as Code.EXCESSIVE_DEPTH]: EXCESSIVE_DEPTH,
  ["CBPR_006" as Code.INVALID_AND_ARITY]: INVALID_AND_ARITY,
  ["CBPR_007" as Code.INVALID_OR_ARITY]: INVALID_OR_ARITY,
  ["CBPR_008" as Code.EMPTY_NOT]: EMPTY_NOT,
  ["CBPR_009" as Code.INVALID_ABSOLUTE_PREDICATE]: INVALID_ABSOLUTE_PREDICATE,
  ["CBPR_010" as Code.INVALID_RELATIVE_PREDICATE]: INVALID_RELATIVE_PREDICATE,
  ["CBPR_011" as Code.EMPTY_ALL_OF]: EMPTY_ALL_OF,
  ["CBPR_012" as Code.EMPTY_ANY_OF]: EMPTY_ANY_OF,
  ["CBPR_013" as Code.EMPTY_TIME_WINDOW]: EMPTY_TIME_WINDOW,
};
