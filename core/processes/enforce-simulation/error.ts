...
export const ERROR_BY_CODE = {
  ["EFS_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["EFS_001" as Code.MISSING_TRANSACTION]: MISSING_TRANSACTION,
  ["EFS_002" as Code.MISSING_RECORDING_SIMULATION]:
    MISSING_RECORDING_SIMULATION,
  ["EFS_003" as Code.MISSING_RPC]: MISSING_RPC,
};
