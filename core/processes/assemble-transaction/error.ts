...
export const ERROR_BY_CODE = {
  ["ASM_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["ASM_001" as Code.MISSING_ARG]: MISSING_ARG,
  ["ASM_002" as Code.NOT_SMART_CONTRACT_TRANSACTION]:
    NOT_SMART_CONTRACT_TRANSACTION_ERROR,
  ["ASM_003" as Code.UNSUPPORTED_OPERATION]: UNSUPPORTED_OPERATION_ERROR,
  ["ASM_004" as Code.FAILED_TO_ASSEMBLE_TRANSACTION]:
    FAILED_TO_ASSEMBLE_TRANSACTION_ERROR,
  ["ASM_005" as Code.FAILED_TO_BUILD_TRANSACTION]:
    FAILED_TO_BUILD_TRANSACTION_ERROR,
  ["ASM_006" as Code.FAILED_TO_BUILD_SOROBAN_DATA]:
    FAILED_TO_BUILD_SOROBAN_DATA_ERROR,
  ["ASM_007" as Code.INVALID_TRANSACTION_FEE_CONFIGURATION]:
    INVALID_TRANSACTION_FEE_CONFIGURATION_ERROR,
  ["ASM_008" as Code.INVALID_BASE_FEE]: INVALID_BASE_FEE_ERROR,
  ["ASM_009" as Code.INVALID_INCLUSION_FEE]: INVALID_INCLUSION_FEE_ERROR,
  ["ASM_010" as Code.INVALID_MAX_FEE]: INVALID_MAX_FEE_ERROR,
  ["ASM_011" as Code.BASE_FEE_TOO_LOW]: BASE_FEE_TOO_LOW_ERROR,
  ["ASM_012" as Code.INCLUSION_FEE_TOO_LOW]: INCLUSION_FEE_TOO_LOW_ERROR,
  ["ASM_013" as Code.MAX_FEE_TOO_LOW]: MAX_FEE_TOO_LOW_ERROR,
  ["ASM_014" as Code.TRANSACTION_FEE_TOO_HIGH]: TRANSACTION_FEE_TOO_HIGH_ERROR,
  ["ASM_015" as Code.TRANSACTION_FEE_BELOW_RESOURCE_FEE]:
    TRANSACTION_FEE_BELOW_RESOURCE_FEE_ERROR,
  ["ASM_016" as Code.INVALID_RESOURCE_FEE]: INVALID_RESOURCE_FEE_ERROR,
  ["ASM_017" as Code.RESOURCE_FEE_BELOW_SIMULATED_MINIMUM]:
