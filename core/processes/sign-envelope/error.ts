...
export const ERROR_BY_CODE = {
  ["SEN_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["SEN_001" as Code.NO_REQUIREMENTS]: NO_REQUIREMENTS,
  ["SEN_002" as Code.NO_SIGNERS]: NO_SIGNERS,
  ["SEN_003" as Code.SIGNER_NOT_FOUND]: SIGNER_NOT_FOUND,
  ["SEN_004" as Code.FAILED_TO_SIGN_TRANSACTION]: FAILED_TO_SIGN_TRANSACTION,
  ["SEN_005" as Code.FAILED_TO_GET_SIGNER_KEY]: FAILED_TO_GET_SIGNER_KEY,
  ["SEN_006" as Code.DUPLICATE_SIGNER_KEY]: DUPLICATE_SIGNER_KEY,
  ["SEN_007" as Code.EXTRA_SIGNER_NOT_FOUND]: EXTRA_SIGNER_NOT_FOUND,
  ["SEN_008" as Code.UNSUPPORTED_PRE_AUTH_EXTRA_SIGNER]:
    UNSUPPORTED_PRE_AUTH_EXTRA_SIGNER,
  ["SEN_009" as Code.AMBIGUOUS_ACCOUNT_SIGNERS]: AMBIGUOUS_ACCOUNT_SIGNERS,
  ["SEN_010" as Code.FAILED_TO_CHECK_SIGNER_TARGET]:
    FAILED_TO_CHECK_SIGNER_TARGET,
  ["SEN_011" as Code.FAILED_TO_CHECK_PRE_AUTH_TRANSACTION]:
    FAILED_TO_CHECK_PRE_AUTH_TRANSACTION,
  ["SEN_012" as Code.PRE_AUTH_TRANSACTION_MISMATCH]:
    PRE_AUTH_TRANSACTION_MISMATCH,
  ["SEN_013" as Code.FAILED_TO_READ_EXTRA_SIGNERS]:
    FAILED_TO_READ_EXTRA_SIGNERS,
  ["SEN_014" as Code.FAILED_TO_PARSE_SIGNED_TRANSACTION]:
