...
export const ERROR_BY_CODE = {
  ["BTX_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["BTX_001" as Code.INVALID_BASE_FEE]: INVALID_BASE_FEE_ERROR,
  ["BTX_002" as Code.BASE_FEE_TOO_LOW]: BASE_FEE_TOO_LOW_ERROR,
  ["BTX_003" as Code.COULD_NOT_LOAD_SOURCE_ACCOUNT]:
    COULD_NOT_LOAD_ACCOUNT_ERROR,
  ["BTX_004" as Code.COULD_NOT_CREATE_TRANSACTION_BUILDER]:
    COULD_NOT_CREATE_TRANSACTION_BUILDER_ERROR,
  ["BTX_005" as Code.COULD_NOT_SET_SOROBAN_DATA]:
    COULD_NOT_SET_SOROBAN_DATA_ERROR,
  ["BTX_006" as Code.COULD_NOT_BUILD_TRANSACTION]:
    COULD_NOT_BUILD_TRANSACTION_ERROR,
  ["BTX_007" as Code.COULD_NOT_INITIALIZE_ACCOUNT_WITH_SEQUENCE]:
    COULD_NOT_INITIALIZE_ACCOUNT_WITH_SEQUENCE_ERROR,
  ["BTX_008" as Code.CONFLICTING_TIME_CONSTRAINTS]:
    CONFLICTING_TIME_CONSTRAINTS_ERROR,
  ["BTX_009" as Code.FAILED_TO_SET_PRECONDITIONS]:
    FAILED_TO_SET_PRECONDITIONS_ERROR,
  ["BTX_010" as Code.NO_OPERATIONS_PROVIDED]: NO_OPERATIONS_PROVIDED_ERROR,
  ["BTX_011" as Code.RPC_REQUIRED_TO_LOAD_ACCOUNT]:
    RPC_REQUIRED_TO_LOAD_ACCOUNT_ERROR,
  ["BTX_012" as Code.INVALID_TRANSACTION_FEE_CONFIGURATION]:
    INVALID_TRANSACTION_FEE_CONFIGURATION_ERROR,
  ["BTX_013" as Code.INVALID_INCLUSION_FEE]: INVALID_INCLUSION_FEE_ERROR,
  ["BTX_014" as Code.INVALID_MAX_FEE]: INVALID_MAX_FEE_ERROR,
  ["BTX_015" as Code.INCLUSION_FEE_TOO_LOW]: INCLUSION_FEE_TOO_LOW_ERROR,
  ["BTX_016" as Code.MAX_FEE_TOO_LOW]: MAX_FEE_TOO_LOW_ERROR,
  ["BTX_017" as Code.TRANSACTION_FEE_TOO_HIGH]: TRANSACTION_FEE_TOO_HIGH_ERROR,
  ["BTX_018" as Code.INVALID_MUXED_SOURCE]: INVALID_MUXED_SOURCE_ERROR,
  ["BTX_019" as Code.INVALID_MUXED_SOURCE_RPC_SEQUENCE]:
    INVALID_MUXED_SOURCE_RPC_SEQUENCE_ERROR,
  ["BTX_020" as Code.INVALID_MUXED_SOURCE_SEQUENCE]:
    INVALID_MUXED_SOURCE_SEQUENCE_ERROR,
};
