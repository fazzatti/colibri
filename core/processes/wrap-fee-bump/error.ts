...
export const ERROR_BY_CODE = {
  ["WFB_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["WFB_002" as Code.ALREADY_FEE_BUMP]: ALREADY_FEE_BUMP,
  ["WFB_003" as Code.NOT_A_TRANSACTION]: NOT_A_TRANSACTION,
  ["WFB_004" as Code.FAILED_TO_BUILD_FEE_BUMP]: FAILED_TO_BUILD_FEE_BUMP,
  ["WFB_001" as Code.MISSING_ARG]: MISSING_ARG,
  ["WFB_005" as Code.FEE_TOO_LOW]: FEE_TOO_LOW,
};
