...
export const ERROR_BY_CODE = {
  ["SIM_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["SIM_001" as Code.SIMULATION_FAILED]: SIMULATION_FAILED,
  ["SIM_002" as Code.COULD_NOT_SIMULATE_TRANSACTION]:
    COULD_NOT_SIMULATE_TRANSACTION,
  ["SIM_003" as Code.SIMULATION_RESULT_NOT_VERIFIED]:
    SIMULATION_RESULT_NOT_VERIFIED,
  ["SIM_004" as Code.CONTRACT_ERROR_SIMULATION_FAILED]:
