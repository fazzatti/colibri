...
export const ERROR_BY_CODE = {
  ["PCTO_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["PCTO_001" as Code.UNEXPECTED_TRANSACTION_RESULT]:
    UNEXPECTED_TRANSACTION_RESULT_ERROR,
  ["PCTO_002" as Code.UNEXPECTED_INNER_TRANSACTION_RESULT]:
    UNEXPECTED_INNER_TRANSACTION_RESULT_ERROR,
  ["PCTO_003" as Code.UNEXPECTED_OPERATION_RESULT]:
    UNEXPECTED_OPERATION_RESULT_ERROR,
  ["PCTO_004" as Code.UNSUPPORTED_OPERATION_OUTCOME]:
    UNSUPPORTED_OPERATION_OUTCOME_ERROR,
  ["PCTO_005" as Code.UNSUCCESSFUL_OPERATION_OUTCOME]:
    UNSUCCESSFUL_OPERATION_OUTCOME_ERROR,
};
