...
export const ERROR_BY_CODE = {
  ["SAE_000" as Code.UNEXPECTED_ERROR]: UNEXPECTED_ERROR,
  ["SAE_001" as Code.MISSING_ARG]: MISSING_ARG,
  ["SAE_002" as Code.VALID_UNTIL_LEDGER_SEQ_TOO_LOW]:
    VALID_UNTIL_LEDGER_SEQ_TOO_LOW,
  ["SAE_003" as Code.VALID_FOR_LEDGERS_TOO_LOW]: VALID_FOR_LEDGERS_TOO_LOW,
  ["SAE_004" as Code.VALID_FOR_SECONDS_TOO_LOW]: VALID_FOR_SECONDS_TOO_LOW,
  ["SAE_005" as Code.FAILED_TO_FETCH_LATEST_LEDGER]:
    FAILED_TO_FETCH_LATEST_LEDGER,
  ["SAE_006" as Code.MISSING_SIGNER]: MISSING_SIGNER,
  ["SAE_007" as Code.FAILED_TO_SIGN_AUTH_ENTRY]: FAILED_TO_SIGN_AUTH_ENTRY,
};
