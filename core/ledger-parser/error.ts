...
export const ERROR_LDP = {
  ["LDP_001" as Code.INVALID_LEDGER_ENTRY]: INVALID_LEDGER_ENTRY,
  ["LDP_002" as Code.INVALID_HEADER_XDR]: INVALID_HEADER_XDR,
  ["LDP_003" as Code.INVALID_METADATA_XDR]: INVALID_METADATA_XDR,
  ["LDP_004" as Code.UNSUPPORTED_LEDGER_CLOSE_META_VERSION]:
    UNSUPPORTED_LEDGER_CLOSE_META_VERSION,
  ["LDP_005" as Code.INVALID_TRANSACTION_INDEX]: INVALID_TRANSACTION_INDEX,
  ["LDP_006" as Code.INVALID_OPERATION_INDEX]: INVALID_OPERATION_INDEX,
  ["LDP_007" as Code.UNSUPPORTED_OPERATION_TYPE]: UNSUPPORTED_OPERATION_TYPE,
  ["LDP_008" as Code.MISSING_TRANSACTION_ENVELOPE]:
    MISSING_TRANSACTION_ENVELOPE,
  ["LDP_009" as Code.UNSUPPORTED_ENVELOPE_TYPE]: UNSUPPORTED_ENVELOPE_TYPE,
  ["LDP_010" as Code.NATIVE_OPERATION_DECODE_FAILED]:
    NATIVE_OPERATION_DECODE_FAILED,
  ["LDP_011" as Code.MISSING_FEE_SOURCE_ENVELOPE]: MISSING_FEE_SOURCE_ENVELOPE,
  ["LDP_012" as Code.MISSING_NATIVE_ENVELOPE]: MISSING_NATIVE_ENVELOPE,
  ["LDP_013" as Code.NATIVE_ENVELOPE_DECODE_FAILED]:
    NATIVE_ENVELOPE_DECODE_FAILED,
  ["LDP_014" as Code.INVALID_NETWORK_PASSPHRASE]: INVALID_NETWORK_PASSPHRASE,
  ["LDP_015" as Code.ENVELOPE_HASH_FAILED]: ENVELOPE_HASH_FAILED,
  ["LDP_016" as Code.DUPLICATE_ENVELOPE_HASH]: DUPLICATE_ENVELOPE_HASH,
  ["LDP_017" as Code.RESULT_ENVELOPE_NOT_FOUND]: RESULT_ENVELOPE_NOT_FOUND,
  ["LDP_018" as Code.UNMATCHED_TRANSACTION_ENVELOPES]:
    UNMATCHED_TRANSACTION_ENVELOPES,
};
