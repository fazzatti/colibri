...
export const ERROR_STAS = {
  ["STAS_001" as Code.INVALID_ASSET]: INVALID_ASSET,
  ["STAS_002" as Code.MISSING_RPC_URL]: MISSING_RPC_URL,
  ["STAS_003" as Code.INVALID_RPC]: INVALID_RPC,
  ["STAS_004" as Code.NATIVE_TRUSTLINE]: NATIVE_TRUSTLINE,
  ["STAS_005" as Code.CHANGE_TRUST_FAILED]: CHANGE_TRUST_FAILED,
  ["STAS_006" as Code.TRANSFER_FAILED]: TRANSFER_FAILED,
  ["STAS_007" as Code.NATIVE_TRUSTLINE_FLAGS]: NATIVE_TRUSTLINE_FLAGS,
  ["STAS_008" as Code.TRUSTLINE_FLAGS_FAILED]: TRUSTLINE_FLAGS_FAILED,
  ["STAS_009" as Code.NATIVE_CLAWBACK]: NATIVE_CLAWBACK,
  ["STAS_010" as Code.CLAWBACK_FAILED]: CLAWBACK_FAILED,
  ["STAS_011" as Code.READ_ISSUER_FAILED]: READ_ISSUER_FAILED,
  ["STAS_012" as Code.READ_TRUSTLINE_FAILED]: READ_TRUSTLINE_FAILED,
  ["STAS_013" as Code.NATIVE_ASSET_CODE_MISMATCH]: NATIVE_ASSET_CODE_MISMATCH,
  ["STAS_014" as Code.INVALID_CANONICAL_ASSET]: INVALID_CANONICAL_ASSET,
  ["STAS_015" as Code.ISSUER_BALANCE_UNDEFINED]: ISSUER_BALANCE_UNDEFINED,
  ["STAS_016" as Code.BALANCE_TRUSTLINE_MISSING]: BALANCE_TRUSTLINE_MISSING,
  ["STAS_017" as Code.READ_BALANCE_FAILED]: READ_BALANCE_FAILED,
  ["STAS_018" as Code.SAC_BINDING_FAILED]: SAC_BINDING_FAILED,
  ["STAS_019" as Code.NATIVE_MINT]: NATIVE_MINT,
  ["STAS_020" as Code.NATIVE_BURN]: NATIVE_BURN,
  ["STAS_021" as Code.NATIVE_AUTHORIZATION]: NATIVE_AUTHORIZATION,
  ["STAS_022" as Code.AUTHORIZATION_TRUSTLINE_MISSING]:
    AUTHORIZATION_TRUSTLINE_MISSING,
  ["STAS_023" as Code.CREATE_CLAIMABLE_BALANCE_FAILED]:
    CREATE_CLAIMABLE_BALANCE_FAILED,
};
