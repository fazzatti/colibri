...
export const ERROR_AMNT = {
  ["AMNT_001" as Code.INVALID_DECIMAL]: INVALID_DECIMAL,
  ["AMNT_002" as Code.EXCESS_PRECISION]: EXCESS_PRECISION,
  ["AMNT_003" as Code.DECIMAL_OVERFLOW]: DECIMAL_OVERFLOW,
  ["AMNT_004" as Code.INVALID_UNITS]: INVALID_UNITS,
};
