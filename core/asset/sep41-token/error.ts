...
export const ERRORS_SEP41_TOKEN = {
  ["SEP41_TOKEN_001" as Code.MISSING_RETURN_VALUE]: MISSING_RETURN_VALUE,
  ["SEP41_TOKEN_002" as Code.FAILED_TO_ENCODE_ALLOWANCE_ARGUMENT_FROM]:
    FAILED_TO_ENCODE_ALLOWANCE_ARGUMENT_FROM,
  ["SEP41_TOKEN_003" as Code.FAILED_TO_ENCODE_ALLOWANCE_ARGUMENT_SPENDER]:
    FAILED_TO_ENCODE_ALLOWANCE_ARGUMENT_SPENDER,
  ["SEP41_TOKEN_004" as Code.FAILED_TO_ENCODE_APPROVE_ARGUMENT_FROM]:
    FAILED_TO_ENCODE_APPROVE_ARGUMENT_FROM,
  ["SEP41_TOKEN_005" as Code.FAILED_TO_ENCODE_APPROVE_ARGUMENT_SPENDER]:
    FAILED_TO_ENCODE_APPROVE_ARGUMENT_SPENDER,
  ["SEP41_TOKEN_006" as Code.FAILED_TO_ENCODE_APPROVE_ARGUMENT_AMOUNT]:
    FAILED_TO_ENCODE_APPROVE_ARGUMENT_AMOUNT,
  ["SEP41_TOKEN_007" as Code.FAILED_TO_ENCODE_APPROVE_ARGUMENT_LIVE_UNTIL_LEDGER]:
    FAILED_TO_ENCODE_APPROVE_ARGUMENT_LIVE_UNTIL_LEDGER,
  ["SEP41_TOKEN_008" as Code.FAILED_TO_ENCODE_BALANCE_ARGUMENT_ID]:
    FAILED_TO_ENCODE_BALANCE_ARGUMENT_ID,
  ["SEP41_TOKEN_009" as Code.FAILED_TO_ENCODE_TRANSFER_ARGUMENT_FROM]:
    FAILED_TO_ENCODE_TRANSFER_ARGUMENT_FROM,
  ["SEP41_TOKEN_010" as Code.FAILED_TO_ENCODE_TRANSFER_ARGUMENT_TO]:
    FAILED_TO_ENCODE_TRANSFER_ARGUMENT_TO,
  ["SEP41_TOKEN_011" as Code.FAILED_TO_ENCODE_TRANSFER_ARGUMENT_AMOUNT]:
    FAILED_TO_ENCODE_TRANSFER_ARGUMENT_AMOUNT,
  ["SEP41_TOKEN_012" as Code.FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_SPENDER]:
    FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_SPENDER,
  ["SEP41_TOKEN_013" as Code.FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_FROM]:
    FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_FROM,
  ["SEP41_TOKEN_014" as Code.FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_TO]:
    FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_TO,
  ["SEP41_TOKEN_015" as Code.FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_AMOUNT]:
    FAILED_TO_ENCODE_TRANSFER_FROM_ARGUMENT_AMOUNT,
  ["SEP41_TOKEN_016" as Code.FAILED_TO_ENCODE_BURN_ARGUMENT_FROM]:
    FAILED_TO_ENCODE_BURN_ARGUMENT_FROM,
  ["SEP41_TOKEN_017" as Code.FAILED_TO_ENCODE_BURN_ARGUMENT_AMOUNT]:
    FAILED_TO_ENCODE_BURN_ARGUMENT_AMOUNT,
  ["SEP41_TOKEN_018" as Code.FAILED_TO_ENCODE_BURN_FROM_ARGUMENT_SPENDER]:
    FAILED_TO_ENCODE_BURN_FROM_ARGUMENT_SPENDER,
  ["SEP41_TOKEN_019" as Code.FAILED_TO_ENCODE_BURN_FROM_ARGUMENT_FROM]:
    FAILED_TO_ENCODE_BURN_FROM_ARGUMENT_FROM,
  ["SEP41_TOKEN_020" as Code.FAILED_TO_ENCODE_BURN_FROM_ARGUMENT_AMOUNT]:
