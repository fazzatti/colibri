...
export const ERROR_XDR = {
  ["HLP_XDR_05" as Code.UNKNOWN_ASSET_TYPE]: UNKNOWN_ASSET_TYPE,
  ["HLP_XDR_06" as Code.UNKNOWN_CHANGE_TRUST_ASSET_TYPE]:
    UNKNOWN_CHANGE_TRUST_ASSET_TYPE,
  ["HLP_XDR_12" as Code.UNKNOWN_TRUSTLINE_ASSET_TYPE]:
    UNKNOWN_TRUSTLINE_ASSET_TYPE,
  ["HLP_XDR_07" as Code.UNKNOWN_MUXED_ACCOUNT_TYPE]: UNKNOWN_MUXED_ACCOUNT_TYPE,
  ["HLP_XDR_08" as Code.INVALID_XDR_PARSE]: INVALID_XDR_PARSE,
  ["HLP_XDR_01" as Code.FAILED_TO_GET_AUTH_ENTRY_ADDRESS_TYPE]:
    FAILED_TO_GET_AUTH_ENTRY_ADDRESS_TYPE,
  ["HLP_XDR_02" as Code.FAILED_TO_GET_AUTH_ENTRY_SIGNER]:
    FAILED_TO_GET_AUTH_ENTRY_SIGNER,
  ["HLP_XDR_13" as Code.FAILED_TO_GET_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_SIGNER]:
    FAILED_TO_GET_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_SIGNER,
  ["HLP_XDR_14" as Code.MISSING_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_SIGNER]:
    MISSING_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_SIGNER,
  ["HLP_XDR_15" as Code.FAILED_TO_GET_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_ADDRESS_TYPE]:
    FAILED_TO_GET_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_ADDRESS_TYPE,
  ["HLP_XDR_16" as Code.MISSING_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_ADDRESS_TYPE]:
    MISSING_AUTH_ENTRY_ADDRESS_CREDENTIALS_FOR_ADDRESS_TYPE,
  ["HLP_XDR_03" as Code.INVALID_AUTH_ENTRY_SIGNER_ADDRESS]:
    INVALID_AUTH_ENTRY_SIGNER_ADDRESS,
  ["HLP_XDR_04" as Code.FAILED_TO_PARSE_ERROR_RESULT]:
    FAILED_TO_PARSE_ERROR_RESULT,
  ["HLP_XDR_10" as Code.UNSUPPORTED_SCVAL_TYPE]: UNSUPPORTED_SCVAL_TYPE,
  ["HLP_XDR_11" as Code.UNKNOWN_SCVAL_TYPE]: UNKNOWN_SCVAL_TYPE,
} as const;
