...
export const ERROR_SDEX = {
  ...
  [Code.UPDATE_SELL_FAILED]: UPDATE_SELL_FAILED,
  [Code.CREATE_BUY_FAILED]: CREATE_BUY_FAILED,
  [Code.UPDATE_BUY_FAILED]: UPDATE_BUY_FAILED,
  [Code.CREATE_PASSIVE_FAILED]: CREATE_PASSIVE_FAILED,
  [Code.OFFER_NOT_FOUND]: OFFER_NOT_FOUND,
