...
export const ERROR_EVT = {
  ["EVT_001" as Code.INVALID_CONTRACT_ID]: INVALID_CONTRACT_ID,
  ["EVT_002" as Code.INVALID_EVENT_ID]: INVALID_EVENT_ID,
  ["EVT_003" as Code.UNKNOWN_EVENT_TYPE]: UNKNOWN_EVENT_TYPE,
  ["EVT_004" as Code.UNKNOWN_FIELD]: UNKNOWN_FIELD,
  ["EVT_005" as Code.EVENT_SCHEMA_MISMATCH]: EVENT_SCHEMA_MISMATCH,
  ["EVT_006" as Code.UNSUPPORTED_SCHEMA_FIELD_TYPE]:
    UNSUPPORTED_SCHEMA_FIELD_TYPE,
  ["EVT_007" as Code.INVALID_EVENT_DATA_FORMAT]: INVALID_EVENT_DATA_FORMAT,
  ["EVT_008" as Code.INVALID_EVENT_ASSET_FORMAT]: INVALID_EVENT_ASSET_FORMAT,
  ["EVT_009" as Code.TRANSFER_EXTENSION_DECODER_FAILED]:
    TRANSFER_EXTENSION_DECODER_FAILED,
  ["EVT_010" as Code.APPROVE_EXTENSION_DECODER_FAILED]:
    APPROVE_EXTENSION_DECODER_FAILED,
  ["EVT_011" as Code.BURN_EXTENSION_DECODER_FAILED]:
    BURN_EXTENSION_DECODER_FAILED,
  ["EVT_012" as Code.MINT_EXTENSION_DECODER_FAILED]:
    MINT_EXTENSION_DECODER_FAILED,
  ["EVT_013" as Code.CLAWBACK_EXTENSION_DECODER_FAILED]:
    CLAWBACK_EXTENSION_DECODER_FAILED,
};
