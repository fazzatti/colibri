...
export const ERROR_LDE = {
  ["LDE_000" as Code.INVALID_CONSTRUCTOR_ARGS]: INVALID_CONSTRUCTOR_ARGS,
  ["LDE_001" as Code.MISSING_RPC_URL]: MISSING_RPC_URL,
  ["LDE_002" as Code.INVALID_ACCOUNT_ID]: INVALID_ACCOUNT_ID,
  ["LDE_014" as Code.INVALID_OFFER_ID]: INVALID_OFFER_ID,
  ["LDE_003" as Code.INVALID_CONTRACT_ID]: INVALID_CONTRACT_ID,
  ["LDE_004" as Code.INVALID_CLAIMABLE_BALANCE_ID]:
    INVALID_CLAIMABLE_BALANCE_ID,
  ["LDE_005" as Code.INVALID_LIQUIDITY_POOL_ID]: INVALID_LIQUIDITY_POOL_ID,
  ["LDE_006" as Code.INVALID_HEX_HASH]: INVALID_HEX_HASH,
  ["LDE_007" as Code.INVALID_CONFIG_SETTING_ID]: INVALID_CONFIG_SETTING_ID,
  ["LDE_008" as Code.INVALID_LEDGER_KEY_HASH]: INVALID_LEDGER_KEY_HASH,
  ["LDE_009" as Code.LEDGER_ENTRY_NOT_FOUND]: LEDGER_ENTRY_NOT_FOUND,
  ["LDE_010" as Code.UNEXPECTED_LEDGER_ENTRY_TYPE]:
    UNEXPECTED_LEDGER_ENTRY_TYPE,
  ["LDE_011" as Code.CONTRACT_INSTANCE_HAS_NO_WASM_HASH]:
    CONTRACT_INSTANCE_HAS_NO_WASM_HASH,
  ["LDE_012" as Code.UNSUPPORTED_RPC_LEDGER_KEY]: UNSUPPORTED_RPC_LEDGER_KEY,
  ["LDE_013" as Code.UNSUPPORTED_XDR_VARIANT]: UNSUPPORTED_XDR_VARIANT,
  ["LDE_015" as Code.INVALID_EXTERNAL_REFERENCE]: INVALID_EXTERNAL_REFERENCE,
  ["LDE_016" as Code.EXTERNAL_REFERENCE_OWNER_NOT_CONTRACT]:
    EXTERNAL_REFERENCE_OWNER_NOT_CONTRACT,
  ["LDE_017" as Code.EXTERNAL_REFERENCE_ENTRY_NOT_FOUND]:
    EXTERNAL_REFERENCE_ENTRY_NOT_FOUND,
  ["LDE_018" as Code.EXTERNAL_REFERENCE_VALUE_INVALID]:
    EXTERNAL_REFERENCE_VALUE_INVALID,
} as const;
