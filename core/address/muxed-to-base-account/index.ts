...
export const muxedAddressToBaseAccount = (
  ...
  assert(
    ...
    new ERROR.INVALID_MUXED_ADDRESS(muxedAddress),
  );
  ...
  try {
    ...
    throw new ERROR.FAILED_TO_LOAD_MUXED_ACCOUNT_FROM_ADDRESS(
      muxedAddress,
      e as Error,
    );
  }
  ...
  try {
    ...
    throw new ERROR.FAILED_TO_RETRIEVE_THE_BASE_ACCOUNT_ID(
      muxedAddress,
      e as Error,
    );
  }
