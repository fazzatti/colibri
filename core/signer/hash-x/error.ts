...
export const ERROR_BY_CODE = {
  ["SIG_HSX_001" as Code.INVALID_PREIMAGE_LENGTH]: INVALID_PREIMAGE_LENGTH,
  ["SIG_HSX_002" as Code.PREIMAGE_NOT_ACCESSIBLE]: PREIMAGE_NOT_ACCESSIBLE,
  ["SIG_HSX_003" as Code.SIGNER_DESTROYED]: SIGNER_DESTROYED,
  ["SIG_HSX_004" as Code.FAILED_TO_GENERATE_PREIMAGE]:
    FAILED_TO_GENERATE_PREIMAGE,
  ["SIG_HSX_005" as Code.FAILED_TO_DERIVE_HASH]: FAILED_TO_DERIVE_HASH,
  ["SIG_HSX_006" as Code.FAILED_TO_ENCODE_SIGNER_KEY]:
    FAILED_TO_ENCODE_SIGNER_KEY,
  ["SIG_HSX_007" as Code.FAILED_TO_ADD_PREIMAGE_SIGNATURE]:
    FAILED_TO_ADD_PREIMAGE_SIGNATURE,
  ["SIG_HSX_008" as Code.FAILED_TO_SERIALIZE_TRANSACTION]:
    FAILED_TO_SERIALIZE_TRANSACTION,
  ["SIG_HSX_009" as Code.FAILED_TO_NORMALIZE_PREIMAGE]:
    FAILED_TO_NORMALIZE_PREIMAGE,
};
