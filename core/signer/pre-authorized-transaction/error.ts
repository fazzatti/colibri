...
export const ERROR_BY_CODE = {
  ["SIG_PAT_001" as Code.INVALID_TRANSACTION_HASH_LENGTH]:
    INVALID_TRANSACTION_HASH_LENGTH,
  ["SIG_PAT_002" as Code.FAILED_TO_HASH_TRANSACTION_DURING_CREATION]:
    FAILED_TO_HASH_TRANSACTION_DURING_CREATION,
  ["SIG_PAT_003" as Code.FAILED_TO_DECODE_SIGNER_KEY]:
    FAILED_TO_DECODE_SIGNER_KEY,
  ["SIG_PAT_004" as Code.FAILED_TO_ENCODE_SIGNER_KEY]:
    FAILED_TO_ENCODE_SIGNER_KEY,
  ["SIG_PAT_005" as Code.FAILED_TO_HASH_TRANSACTION_DURING_AUTHORIZATION]:
    FAILED_TO_HASH_TRANSACTION_DURING_AUTHORIZATION,
  ["SIG_PAT_006" as Code.FAILED_TO_NORMALIZE_TRANSACTION_HASH]:
