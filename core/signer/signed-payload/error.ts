...
export const ERROR_BY_CODE = {
  ["SIG_SPL_001" as Code.INVALID_PAYLOAD_LENGTH]: INVALID_PAYLOAD_LENGTH,
  ["SIG_SPL_002" as Code.FAILED_TO_GET_PUBLIC_KEY]: FAILED_TO_GET_PUBLIC_KEY,
  ["SIG_SPL_003" as Code.FAILED_TO_DECODE_PUBLIC_KEY]:
    FAILED_TO_DECODE_PUBLIC_KEY,
  ["SIG_SPL_004" as Code.FAILED_TO_HASH_TRANSACTION]:
    FAILED_TO_HASH_TRANSACTION,
  ["SIG_SPL_005" as Code.FAILED_TO_SIGN_PAYLOAD]: FAILED_TO_SIGN_PAYLOAD,
  ["SIG_SPL_006" as Code.FAILED_TO_BUILD_DECORATED_SIGNATURE]:
    FAILED_TO_BUILD_DECORATED_SIGNATURE,
  ["SIG_SPL_007" as Code.FAILED_TO_ADD_DECORATED_SIGNATURE]:
    FAILED_TO_ADD_DECORATED_SIGNATURE,
  ["SIG_SPL_008" as Code.FAILED_TO_SERIALIZE_TRANSACTION]:
    FAILED_TO_SERIALIZE_TRANSACTION,
  ["SIG_SPL_009" as Code.FAILED_TO_NORMALIZE_PAYLOAD]:
    FAILED_TO_NORMALIZE_PAYLOAD,
  ["SIG_SPL_010" as Code.FAILED_TO_BUILD_SIGNER_KEY_XDR]:
    FAILED_TO_BUILD_SIGNER_KEY_XDR,
  ["SIG_SPL_011" as Code.FAILED_TO_ENCODE_SIGNER_KEY]:
    FAILED_TO_ENCODE_SIGNER_KEY,
  ["SIG_SPL_012" as Code.FAILED_TO_NORMALIZE_SIGNATURE]:
    FAILED_TO_NORMALIZE_SIGNATURE,
};
