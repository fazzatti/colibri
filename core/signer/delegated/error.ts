...
export const ERROR_BY_CODE = {
  ["SIG_DEL_001" as Code.DUPLICATE_NESTED_DELEGATE]: DUPLICATE_NESTED_DELEGATE,
  ["SIG_DEL_002" as Code.FAILED_TO_BUILD_DELEGATED_ENTRY]:
    FAILED_TO_BUILD_DELEGATED_ENTRY,
  ["SIG_DEL_003" as Code.FAILED_TO_AUTHORIZE_DELEGATE]:
    FAILED_TO_AUTHORIZE_DELEGATE,
};
