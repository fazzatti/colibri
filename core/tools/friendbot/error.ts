...
export const ERROR_TOOL_FRDBOT = {
  ["TOOL_FRDBOT_000" as Code.UNEXPECTED]: UNEXPECTED,
  ["TOOL_FRDBOT_001" as Code.INVALID_ADDRESS]: INVALID_ADDRESS,
  ["TOOL_FRDBOT_002" as Code.RPC_PROPAGATION_TIMEOUT]: RPC_PROPAGATION_TIMEOUT,
};
