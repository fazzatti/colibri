...
- [Overview](packages/react.md)
- [Setup and providers](packages/react/setup.md)
...
- [Hooks](packages/react/hooks/README.md)
  ...
  - [useColibriConfig](packages/react/hooks/use-colibri-config.md)
  - [useConnection](packages/react/hooks/use-connection.md)
  - [useConnect](packages/react/hooks/use-connect.md)
  - [useReconnect](packages/react/hooks/use-reconnect.md)
  - [useDisconnect](packages/react/hooks/use-disconnect.md)
  - [useNetwork](packages/react/hooks/use-network.md)
  - [useRpc](packages/react/hooks/use-rpc.md)
  - [useLatestLedger](packages/react/hooks/use-latest-ledger.md)
  - [useTransaction](packages/react/hooks/use-transaction.md)
  - [useWaitForTransaction](packages/react/hooks/use-wait-for-transaction.md)
  - [useLedgerEntries](packages/react/hooks/use-ledger-entries.md)
  - [useAccount](packages/react/hooks/use-account.md)
  - [useTrustline](packages/react/hooks/use-trustline.md)
  - [useBalance](packages/react/hooks/use-balance.md)
  - [useTokenMetadata](packages/react/hooks/use-token-metadata.md)
  - [useContract](packages/react/hooks/use-contract.md)
  - [useContractRead](packages/react/hooks/use-contract-read.md)
  - [useContractReadSpec](packages/react/hooks/use-contract-read-spec.md)
  - [useWalletContractInvoke](packages/react/hooks/use-wallet-contract-invoke.md)
  - [useContractInvoke](packages/react/hooks/use-contract-invoke.md)
  - [useColibriMutation](packages/react/hooks/use-colibri-mutation.md)
  - [useClassicTransaction](packages/react/hooks/use-classic-transaction.md)
  - [useSorobanTransaction](packages/react/hooks/use-soroban-transaction.md)
  - [useSimulateSorobanTransaction](packages/react/hooks/use-simulate-soroban-transaction.md)
  - [useContractEvents](packages/react/hooks/use-contract-events.md)
  - [useSigners](packages/react/hooks/use-signers.md)
  - [useSignMessage](packages/react/hooks/use-sign-message.md)
  - [useWebAuthClient](packages/react/hooks/use-web-auth-client.md)
  - [useSession](packages/react/hooks/use-session.md)
  - [useWebAuth](packages/react/hooks/use-web-auth.md)
  - [useStellarToml](packages/react/hooks/use-stellar-toml.md)
  - [useIdenticon](packages/react/hooks/use-identicon.md)
...
- [Asset](core/asset/README.md)
  - [StellarAsset account operations](core/asset/stellar-asset.md)
...
- [Signer](core/signer/README.md)
  ...
  - [SEP-53 message signing](core/signer/message-signing.md)
- [Transaction Config](core/transaction-config.md)
  - [Resource overrides, padding and calculation](core/resources.md)
- [SDEX offers and exact prices](core/sdex.md)
- [Native liquidity pools](core/liquidity-pool.md)
- [Claimable-balance predicates](core/claimable-balance-predicates.md)
...
- [Generate with the CLI](packages/contract-bindings/cli.md)
- [Output packages and Core conveniences](packages/contract-bindings/output.md)
- [Generated clients and values](packages/contract-bindings/generated-client.md)
- [Generated errors and events](packages/contract-bindings/errors-and-events.md)
- [Programmatic generation](packages/contract-bindings/programmatic.md)
- [Failures and ABI upgrades](packages/contract-bindings/troubleshooting.md)

## @colibri/rpc-streamer

- [Overview](packages/rpc-streamer.md)
- [Stream events](packages/rpc-streamer/events.md)
- [Stream ledgers](packages/rpc-streamer/ledgers.md)
- [Stream transactions and operations](packages/rpc-streamer/transactions-and-operations.md)
...
- [Overview](packages/build-verification.md)
...
- [Overview](packages/identicon.md)
- [Render and style an identicon](packages/identicon/rendering.md)
- [Contract address identicons](packages/identicon/contract-addresses.md)
- [Custom renderers](packages/identicon/custom-renderers.md)
- [Errors and compatibility](packages/identicon/errors-and-compatibility.md)

## @colibri/test-tooling

- [Overview](packages/test-tooling.md)
...
- [Overview](packages/plugins/README.md)
...
- [Error codes by context](reference/errors/README.md)
  ...
  - [core/asset/native](reference/errors/core-asset-native.md)
  ...
  - [core/markets/liquidity-pools](reference/errors/core-markets-liquidity-pools.md)
  - [core/markets/price](reference/errors/core-markets-price.md)
  - [core/markets/sdex](reference/errors/core-markets-sdex.md)
  ...
  - [core/resources](reference/errors/core-resources.md)
