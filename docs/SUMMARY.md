...
- [Core](core/overview.md)
  ...
  - [Processes](core/processes/README.md)
    ...
    - [PostAuthAssembleTransaction](core/processes/post-auth-assemble-transaction.md)
    - [PostAuthEnforcedSimulation](core/processes/post-auth-enforced-simulation.md)
