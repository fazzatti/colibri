...
| `NLP_011` | `INVALID_PRICE_ASSETS` — A labelled price must name this pool's two distinct assets.       | [Definition](https://github.com/fazzatti/colibri/blob/main/core/liquidity-pool/error.ts#L15) |
| `NLP_012` | `REVERSED_PRICE_BOUNDS` — A price interval has a minimum greater than its maximum.         | [Definition](https://github.com/fazzatti/colibri/blob/main/core/liquidity-pool/error.ts#L16) |
| `NLP_013` | `POSITION_POOL_MISSING` — The position query found no pool entry.                          | [Definition](https://github.com/fazzatti/colibri/blob/main/core/liquidity-pool/error.ts#L17) |
| `NLP_014` | `POSITION_TRUSTLINE_MISSING` — The position query found no pool-share trustline.           | [Definition](https://github.com/fazzatti/colibri/blob/main/core/liquidity-pool/error.ts#L18) |
| `NLP_015` | `FAILED_TO_READ_POSITION` — A native transport failure prevented the position observation. | [Definition](https://github.com/fazzatti/colibri/blob/main/core/liquidity-pool/error.ts#L19) |
