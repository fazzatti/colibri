...
| `BTX_018` | `INVALID_MUXED_SOURCE` — Raised when the base G-account cannot be resolved from a muxed source.                               | [Definition](https://github.com/fazzatti/colibri/blob/main/core/processes/build-transaction/error.ts#L26) |
| `BTX_019` | `INVALID_MUXED_SOURCE_RPC_SEQUENCE` — Raised when a muxed source cannot use the sequence loaded from RPC.                     | [Definition](https://github.com/fazzatti/colibri/blob/main/core/processes/build-transaction/error.ts#L27) |
| `BTX_020` | `INVALID_MUXED_SOURCE_SEQUENCE` — Raised when a muxed source cannot use an explicitly provided sequence.                      | [Definition](https://github.com/fazzatti/colibri/blob/main/core/processes/build-transaction/error.ts#L28) |
