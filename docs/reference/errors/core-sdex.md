...
| `SDEX_010` | `READ_OFFER_FAILED` — Native transport failed while querying a known offer.                       | [Definition](https://github.com/fazzatti/colibri/blob/main/core/sdex/error.ts#L14) |
