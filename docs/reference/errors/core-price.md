...
| `PRCE_005` | `ZERO_PRICE_AMOUNT` — A quantity-based exchange price requires two positive amounts.                 | [Definition](https://github.com/fazzatti/colibri/blob/main/core/price/error.ts#L9)  |
| `PRCE_006` | `UNREPRESENTABLE_AMOUNTS` — Exact quantity conversion would exceed the native price component range. | [Definition](https://github.com/fazzatti/colibri/blob/main/core/price/error.ts#L10) |
