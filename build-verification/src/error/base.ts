...
export enum Code {
  ...
  IMAGE_REFERENCE_POLICY_REJECTED = "BLDV_099",
  ARCHIVE_SOURCE_PROVIDER_INPUT_MISMATCH = "BLDV_100",
  FILE_SOURCE_PROVIDER_INPUT_MISMATCH = "BLDV_101",
  HTTP_SOURCE_PROVIDER_INPUT_MISMATCH = "BLDV_102",
  GITHUB_SOURCE_PROVIDER_INPUT_MISMATCH = "BLDV_103",
  IMAGE_AUTHENTICATION_CHALLENGE_INVALID = "BLDV_104",
  IMAGE_REGISTRY_REQUEST_REJECTED = "BLDV_105",
  CLI_POSITIONAL_ARGUMENT_UNSUPPORTED = "BLDV_106",
  CLI_UNKNOWN_FLAG = "BLDV_107",
  CLI_DUPLICATE_FLAG = "BLDV_108",
  CLI_FLAG_VALUE_MISSING = "BLDV_109",
  CLI_HELP_CONFLICT = "BLDV_110",
  CLI_LOG_FORMAT_INVALID = "BLDV_111",
  CLI_LOG_FORMAT_REQUIRES_LOGS = "BLDV_112",
  CLI_TARGET_SELECTION_INVALID = "BLDV_113",
  CLI_TARGET_FILE_READ_FAILED = "BLDV_114",
  CLI_NETWORK_CONFIGURATION_CONFLICT = "BLDV_115",
  CLI_NETWORK_PRESET_INVALID = "BLDV_116",
  CLI_NETWORK_CONFIGURATION_INCOMPLETE = "BLDV_117",
  CLI_ALLOW_HTTP_REQUIRES_NETWORK = "BLDV_118",
  CLI_SOURCE_SELECTION_INVALID = "BLDV_119",
  CLI_GITHUB_SOURCE_INCOMPLETE = "BLDV_120",
  CLI_GITHUB_REVISION_CONFLICT = "BLDV_121",
  CLI_GITHUB_FORMAT_INVALID = "BLDV_122",
  CLI_GITHUB_RELEASE_INVALID = "BLDV_123",
  CLI_OUT_OF_BAND_SOURCE_REQUIRED = "BLDV_124",
  CLI_RECIPE_FILE_READ_FAILED = "BLDV_125",
  CLI_RECIPE_JSON_INVALID = "BLDV_126",
  CLI_ENVIRONMENT_READ_FAILED = "BLDV_127",
  CLI_ENVIRONMENT_VALUE_MISSING = "BLDV_128",
